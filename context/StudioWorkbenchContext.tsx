...
import { hfImageModels, type HfImageModel } from "@/lib/hf-models";
...
type StudioWorkbenchContextValue = {
  ...
  selectModel: (model: HfImageModel) => void;
...
function useStudioWorkbenchValue({
  ...
  const [selectedModel, setSelectedModel] = useState<HfImageModel>(
    hfImageModels[0],
  );
